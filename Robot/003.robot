...
*** Variables ***
${BROWSER}              Chrome
${VALID_NAME_TH_1}      นางสาว
${VALID_FIRSTNAME_TH}   ศรัญญ์พัฒน์
${VALID_LASTNAME_TH}    สุขแสงศรี
${VALID_NAME_EN_1}      Mr.
${VALID_FIRSTNAME_EN}   Saranphat
${VALID_LASTNAME_EN}    Suksaengsi
${DAY}                  20
${MONTH}                พฤศจิกายน
${YEAR}                 2003
${VALID_ID_CARD}        1739200011000
${VALID_PASSWORD}       P123456789
${VALID_PHONE_NUMBER}   0926111111
${VALID_EMAIL_WEBMAIL}  654259018@webmail.npru.ac.th
...
Input Invalid TH Name
    Select From List by Value    id=nameTitleTha    ${VALID_NAME_TH_1}
    Input Text    id=firstnameTha    Saranphat
    Input Text    id=lastnameTha     Suksaengsi

Input Invalid EN Name
    Select From List by Value    id=nameTitleEng    ${VALID_NAME_EN_1}
    Input Text    id=firstnameEng    ศรัญญ์พัฒน์
    Input Text    id=lastnameEng     สุขแสงศรี
